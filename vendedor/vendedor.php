...
<head>
	...
	<title>Games Room - Tornar-se um vendedor</title>
...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4">Tornar-se um vendedor</h1>
    <p class="lead">Atenção!!<span> <?php echo $nome; ?></span><br>
<h1><small>SEÇÃO 1 - O QUE FAREMOS COM ESTA INFORMAÇÃO?</h1>
...
<h1><small>SEÇÃO 2 - CONSENTIMENTO</small></h1>
...
<p>Se após você nos fornecer seus dados, você mudar de ideia, você pode retirar o seu consentimento para que possamos entrar em contato, para a coleção de dados contínua, uso ou divulgação de suas informações, a qualquer momento, entrando em contato conosco em victorhbbergamo@gmail.com ou nos enviando uma correspondência em: GamesRoom Amazonia, Brasil</p>
<h1><small>SEÇÃO 3 - DIVULGAÇÃO</small></h1>
...
<h1><small>SEÇÃO 4 - SERVIÇOS DE TERCEIROS</small></h1>
...
<h1><small>SEÇÃO 5 - SEGURANÇA</small></h1>
...
<h1><small>SEÇÃO 6 - ALTERAÇÕES PARA ESSA POLÍTICA DE PRIVACIDADE</small></h1>
...
<a class="btn btn-primary" href='vendedorupdate.php'>Concordar</button>
<a class="btn primary" href='javascript:history.back(-1);'>voltar</a>
