...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
<form name="adicionarprodutos" action="adicionar_produtos_bd.php" method="post">
	...
	<div class="form-group">
		Foto:
		<input name="foto" class="form-control" type="text" size="40" maxlength="50"/>
	</div>
	...
	<div class="form-group">
		...
		<br><br><a href="adm.php?id=produtos">Listar produtos</a><br>
	</div>
	</div>
	</div>
</div>
