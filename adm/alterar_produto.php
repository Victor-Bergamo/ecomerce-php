...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
<form name="adicionarprodutos" action="alterar_produto_bd.php" method="post">
	...
	<div class="form-group">
		...
		<select name="categoria" class="form-control">
		  ...
		  <option value="4">Scanners</option>
	...
	<div class="form-group">
		Valor:
		<input name="valor" class="form-control" type="text" size="10" value="<?php echo $valor; ?>" maxlength="15" />
	</div>
	<div class="form-group">
		Qtd estoque:
		<input name="qtdestoque" class="form-control" value="<?php echo $qtdestoque; ?>" type="text" size="8" maxlength="15"/>
	</div>
	<div class="form-group">
		Foto:
		<input name="foto" class="form-control" type="text" size="40" value="<?php echo $foto; ?>" maxlength="50"/>
	</div>
	...
	<div class="form-group">
		...
		<input type="reset" class="btn btn-danger text-center" value="Limpar"/>
