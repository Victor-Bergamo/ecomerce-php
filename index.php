...
?>
		...
		<script>
			...
			open('vendedor/index.php', target='_parent');
...
?> <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class='collapse navbar-collapse' id='navbarTogglerDemo01'>
 		<a class='navbar-brand' target="pri" href='home.php'><img src='img/logo02.png' width='150px'></a>
...
<nav class='navbar navbar-expand-lg navbar-light bg-light'>
	...
	<ul class='navbar-nav mr-auto mt-2 mt-lg-0'>
      ...
      <li class='nav-item active'>
        <a class="btn btn-light" target='pri' href='carrinho.php'><i class='fas fa-shopping-cart'>&nbsp;</i>Carrinho</a> <span class='sr-only'>(current)</span></a>
      	...
      	<button class="btn btn-light" data-toggle='modal' data-target='#ExemploModalCentralizado'>
			  <i class="fa fa-cog" aria-hidden="true"></i>&nbsp;Gerenciar Conta
			</button>
				  ...
				  <div class='modal-dialog modal-dialog-centered' role='document'>
					 <div class='modal-content'>
						...
						<div class='modal-body'>
								...
								Nome: <font style="font-size: 15px;" class="texto6"><?php echo "$nome";?></font><br>
								Email:<font style="font-size: 15px;" class="texto6"> <?php echo "$email";?></font><br>
								<?php
								
									if ($exist > 0){
									
										unset($sql,$resultado, $result);
										$sql="SELECT * FROM Produtos WHERE email='$email'";
										$result=mysqli_query($conexao, $sql);
										$n=mysqli_num_rows($result);
										
										echo "<br><br><h3>Produtos sendo vendidos:</h3> <font style='font-size: 15px;' class='texto6'> $n produto(s) cadastrados</font>";
   ...
   <form action='validalogin.php?sair=sim' target='pri' method='POST' class="form-inline my-2 my-lg-0">
